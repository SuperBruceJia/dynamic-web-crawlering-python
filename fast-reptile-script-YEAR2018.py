...
def read_url(ID: str) -> str:
    ...
    url = 'https://www.nstl.gov.cn/execute?target=nstl4.search4&function=paper/pc/detail&id=C018' + ID
...
def field(ID: str):
    ...
    url = 'https://www.nstl.gov.cn/execute?target=nstl4.search4&function=stkos/pc/detail/ztree&id=C018' + ID
...
if __name__ == '__main__':
    ...
    save_path = 'NSTD-data-2018/'
    if not os.path.exists(save_path):
        os.mkdir(save_path)

    threadl = []
    task1 = threading.Thread(target=run_code, args=(781660, 821660))
    task2 = threading.Thread(target=run_code, args=(821660, 861660))
    task3 = threading.Thread(target=run_code, args=(861660, 901660))
    task4 = threading.Thread(target=run_code, args=(901660, 941660))
    task5 = threading.Thread(target=run_code, args=(941660, 981660))
    task6 = threading.Thread(target=run_code, args=(981660, 1000000))
